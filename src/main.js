import './style.css'
import bnetLogo from './assets/bnetlogo.webp'
import humanIcon from './assets/race-human-icon.webp'
import nightElfIcon from './assets/race-night-elf-icon.webp'
import orcIcon from './assets/race-orc-icon.webp'
import chaemikoImage from './assets/chaemiko-card.webp'
import douyuLogo from './assets/stream-douyu-logo.webp'
import playerEarningsBgImage from './assets/player-earnings-bg-img.webp'
import resourcesPageImage from './assets/resources-page-img.webp'
import infiFireballVideo from './assets/infi-card-fireball-effect.webm'
import fortitudeImage from './assets/fortitude-card.webp'
import hawkImage from './assets/hawk-card.webp'
import humanVsTheWorldLogo from './assets/site-logo-human-vs-the-world.webp'
import infiImage from './assets/infi-card.webp'
import leonImage from './assets/leon-card.webp'
import liquipediaLogo from './assets/liquipedia-logo.webp'
import sokImage from './assets/sok-card.webp'
import twitchLogo from './assets/stream-twitch-logo.svg'
import undeadIcon from './assets/race-undead-icon.webp'
